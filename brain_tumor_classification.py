...
root_dir = 'C:/Masters/ENEL645/FInal Project'
...
time_limit = int(os.getenv('JOB_TIME_LIMIT', '72000'))
safe_margin = 300
...
plot_confusion_matrix(conf_matrix, classes=[str(i) for i in range(2)], filename='test_confusion_matrix.png')
