...
output_file = 'brain_tumor_classification_RESNET152_untrained.txt'
...
for epoch in range(num_epochs):
    ...
    if epoch == num_epochs - 1:
        plot_confusion_matrix(conf_matrix, classes=[str(i) for i in range(2)], filename='confusion_matrix_resnet152_untrained.png')
