...
output_file = 'maps/resnet50_untrain/RESNET50_untrained_gradcam.txt'
...
def compute_grad_cam(model, img_tensor, target_class=None):
    ...
    hook_handle = model.layer4[-1].conv3.register_forward_hook(hook)  # Assuming the last convolutional layer is layer4[2].conv3
...
for image_path in image_paths:
    ...
    os.makedirs("maps/resnet50_untrain", exist_ok=True)

    output_image_path = f"maps/resnet50_untrain/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
