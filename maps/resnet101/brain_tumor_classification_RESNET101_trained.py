...
output_file = 'maps/resnet101/brain_tumor_classification_RESNET101_trained.txt'
...
for image_path in image_paths:
    ...
    os.makedirs("maps/resnet101", exist_ok=True)

    output_image_path = f"maps/resnet101/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
