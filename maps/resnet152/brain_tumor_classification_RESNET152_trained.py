...
output_file = 'maps/resnet152/brain_tumor_classification_RESNET152_trained.txt'
...
for image_path in image_paths:
    ...
    os.makedirs("maps/resnet152", exist_ok=True)

    output_image_path = f"maps/resnet152/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
