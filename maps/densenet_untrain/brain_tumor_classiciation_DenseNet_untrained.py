...
output_file = 'maps/densenet_untrain/DenseNet_untrained.txt'
...
for image_path in image_paths:
    ...
    os.makedirs("maps/densenet", exist_ok=True)

    output_image_path = f"maps/densenet_untrain/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
