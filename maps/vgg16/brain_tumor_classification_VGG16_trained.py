...
output_file = 'maps/vgg16/brain_tumor_classification_VGG16_trained.txt'
...
for image_path in image_paths:
    ...
    os.makedirs("maps/vgg16", exist_ok=True)

    output_image_path = f"maps/vgg16/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
