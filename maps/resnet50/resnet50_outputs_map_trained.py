...
output_file = 'maps/resnet50/RESNET50_trained_gradcam.txt'
...
for image_path in image_paths:
    ...
    os.makedirs("maps/resnet50", exist_ok=True)

    output_image_path = f"maps/resnet50/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
