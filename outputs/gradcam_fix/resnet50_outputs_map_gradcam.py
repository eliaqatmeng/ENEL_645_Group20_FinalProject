...
def save_grad_cam_as_image(grad_cam, original_img, filename='outputs\gradcam_fix\grad_cam.png'):
...
def plot_grad_cam(model, img_path, target_class=None, filename='outputs/grad_cam.png'):
    ...
    # Call save_grad_cam_as_image with the original image
...
for epoch in range(num_epochs):
    ...
    if epoch == num_epochs - 1:
        ...
        print(sample_label)
        plot_grad_cam(model, img_path=r'Brain Tumor Data Set\Brain Tumor Data Set\Brain Tumor\Cancer (4).jpg', target_class=sample_label, filename='outputs/grad_cam.png')
