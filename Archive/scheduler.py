...
script_path1 = os.path.abspath("NewOutputs/densenet/brain_tumor_classiciation_DenseNet.py")
script_path2 = os.path.abspath("NewOutputs/resnet50/resnet50_outputs_map_trained.py")
script_path3 = os.path.abspath("NewOutputs/resnet101/brain_tumor_classification_RESNET101_trained.py")
script_path4 = os.path.abspath("NewOutputs/resnet152/brain_tumor_classification_RESNET152_trained.py")
script_path5 = os.path.abspath("NewOutputs/simplecnn/brain_tumor_classiciation_simple_CNN.py")
script_path6 = os.path.abspath("NewOutputs/vgg16/brain_tumor_classification_VGG16_trained.py")
script_path7 = os.path.abspath("NewOutputs/densenet_untrain/brain_tumor_classiciation_DenseNet_untrained.py")
script_path8 = os.path.abspath("NewOutputs/resnet50_untrain/resnet50_outputs_map_untrained.py")
script_path9 = os.path.abspath("NewOutputs/resnet101_untrain/brain_tumor_classification_RESNET101_untrained.py")
script_path10 = os.path.abspath("NewOutputs/resnet152_untrain/brain_tumor_classification_RESNET152_untrained.py")
script_path11 = os.path.abspath("NewOutputs/vgg16_untrain/brain_tumor_classification_VGG16_untrained.py")
...
try:
    subprocess.run(["python", script_path5], check=True)
    print("\nbrain_tumor_classiciation_simple_CNN.py execution completed successfully.")
except subprocess.CalledProcessError as e:
    print("\nbrain_tumor_classiciation_simple_CNN.py execution failed with error:", e)
