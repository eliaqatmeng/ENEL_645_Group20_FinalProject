...
output_file = 'NewOutputs/resnet50/RESNET50_trained_gradcam.txt'
...
def get_subset_indices(dataset, fraction=0.10):
...
def plot_roc_curve_and_output_auc(labels, probs, filename_png='NewOutputs/resnet50/ROC_curve_resnet50_trained.png', filename_csv='NewOutputs/resnet50/ROC_data_resnet50_trained.csv'):
...
for epoch in range(num_epochs):
    ...
    if epoch == num_epochs - 1:
        ...
        sample_image_path103 = r"Brain Tumor Data Set\Brain Tumor Data Set\Healthy\Not Cancer  (103).jpg" #layer 4
        ...
        plot_grad_cam_for_image(model, image_path=sample_image_path51, actual_class=0, target_class=0, filename='NewOutputs/resnet50/grad_cam51.png')
        plot_grad_cam_for_image(model, image_path=sample_image_path2419, actual_class=1, target_class=1, filename='NewOutputs/resnet50/grad_cam2419.png')
        plot_grad_cam_for_image(model, image_path=sample_image_path2373, actual_class=1, target_class=1, filename='NewOutputs/resnet50/grad_cam2373.png')
        plot_grad_cam_for_image(model, image_path=sample_image_path103, actual_class=0, target_class=0, filename='NewOutputs/resnet50/grad_cam.png')
        plot_grad_cam_for_image(model, image_path=sample_image_path939, actual_class=0, target_class=0, filename='NewOutputs/resnet50/grad_cam.png')

    # Save Confusion Matrix as Image after the last epoch
    if epoch == num_epochs - 1:
        plot_confusion_matrix(conf_matrix, classes=[str(i) for i in range(2)], filename='NewOutputs/resnet50/confusion_matrix_resnet50_trained.png')
